...
import { l as createHooks, m as getContext, j as createError$1, n as toRouteMatcher, o as createRouter, q as defu, r as hasProtocol, v as joinURL, w as withQuery, x as sanitizeStatusCode, y as isScriptProtocol, z as executeAsync, $ as $fetch } from '../_/nitro.mjs';
...
const _routes = [
  ...
  {
    name: "admin-sAdmin-admin-product-id",
    path: "/admin/sAdmin/admin-product/:id()",
    component: () => import('./_id_.vue.mjs')
  },
  {
    name: "admin-sAdmin-admin-product",
    path: "/admin/sAdmin/admin-product",
...
const namedMiddleware = {
  "auth-middleware": () => import('./authMiddleware.mjs'),
  "csrf-middleware": () => import('./csrfMiddleware.mjs'),
  "origin-middleware": () => import('./originMiddleware.mjs'),
  "sec-fetch-middleware": () => import('./secFetchMiddleware.mjs')
};
...
function useCsrf() {
  ...
  {
    return { csrf: (_c = (_b = (_a = useNuxtApp().ssrContext) == null ? void 0 : _a.event) == null ? void 0 : _b.context) == null ? void 0 : _c.csrfToken, headerName };
  }
}

const plugin_xdQC2I5FZA9BN_8d8MWCXWAuqLDNRFNSkZczMVXWDIs = defineNuxtPlugin(() => {
...
const layouts = {
  defaut: defineAsyncComponent(() => import('./defaut.vue.mjs').then((m) => m.default || m))
};
...
export { _export_sfc as _, useRuntimeConfig as a, useNuxtApp as b, useRequestEvent as c, useRouter as d, nuxtLinkDefaults as e, navigateTo as n, resolveRouteObject as r, server as s, useHead as u };
